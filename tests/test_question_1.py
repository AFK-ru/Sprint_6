...
@allure.title("Проверка ответа на 1-й вопрос в Вопросы о важном")
@pytest.mark.parametrize("question, answer, expected", [(MainPageLocators.QUESTION_1, MainPageLocators.ANSWER_1, TextData.ANSWER_1)])
