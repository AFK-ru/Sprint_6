...
@allure.title("Проверка ответа на 3-й вопрос в Вопросы о важном")
@pytest.mark.parametrize("question, answer, expected", [(MainPageLocators.QUESTION_3, MainPageLocators.ANSWER_3, TextData.ANSWER_3)])
