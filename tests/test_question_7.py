...
@allure.title("Проверка ответа на 7-й вопрос в Вопросы о важном")
@pytest.mark.parametrize("question, answer, expected", [(MainPageLocators.QUESTION_7, MainPageLocators.ANSWER_7, TextData.ANSWER_7)])
